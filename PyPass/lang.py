...
language = {
    "ru": {
        ...
        "set_lang": "Язык:",
        "set_location": "Сохранять расположение:",
        "set_loc_tip": "Сохранение места расположения ключа и базы данных существенно увеличивают риски взлома",
        "set_help": "PyPass - Приложение для безопастного хранения паролей.",
    },
    "eng": {},
}
